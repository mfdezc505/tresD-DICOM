...
<p><b>7. Propiedad intelectual.</b> La interfaz y el código propio son © ${OWNER.company} (${OWNER.brand}). Los motores de terceros (Cornerstone3D, vtk.js, dcmjs, dicom-parser, fflate, node-unrar-js / unrar de RARLAB, jsPDF, PptxGenJS, Vite, MediaPipe Face Mesh) se distribuyen bajo sus licencias (MIT, BSD-3, Apache-2.0, UnRAR). No está permitido presentar la herramienta como propia ni retirar las menciones de origen.</p>
...
<p><b>5. Valoración voluntaria.</b> La aplicación ofrece una ventana para puntuar la herramienta (1-5) y dejar un comentario opcional. Solo se envía si el usuario pulsa «Enviar»; es <b>anónima</b> (no se recoge nombre, correo ni dirección IP por parte del titular) y se recibe a través de Google Forms (Google LLC), sujeto a la <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">política de privacidad de Google</a>. Base jurídica: consentimiento (art. 6.1.a RGPD). Le rogamos que no incluya datos personales ni de pacientes en el comentario; si los incluyera, se eliminarían. Puede pedir la supresión de un comentario escribiendo a ${OWNER.email}.</p>
<p><b>6. Sin cuentas ni cookies.</b> La aplicación no requiere registro y no envía correos ni comunicaciones comerciales.</p>
<p><b>7. Derechos.</b> Puede ejercer los derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad escribiendo a ${OWNER.email}, y reclamar ante la Agencia Española de Protección de Datos (www.aepd.es). Dado que no se recogen datos personales identificables, en la práctica no existen datos que entregar o suprimir.</p>
<p><b>8. Cambios.</b> Esta política puede actualizarse; la fecha de versión es ${TERMS_VERSION}.</p>`,
...
<p><b>7. Intellectual property.</b> The interface and original code are © ${OWNER.company} (${OWNER.brand}). Third-party engines (Cornerstone3D, vtk.js, dcmjs, dicom-parser, fflate, node-unrar-js / RARLAB unrar, jsPDF, PptxGenJS, Vite, MediaPipe Face Mesh) are distributed under their own licenses (MIT, BSD-3, Apache-2.0, UnRAR). Presenting the tool as your own or removing attribution is not allowed.</p>
...
<p><b>5. Voluntary rating.</b> The application offers a window to rate the tool (1-5) and leave an optional comment. It is sent only when the user clicks "Send"; it is <b>anonymous</b> (the owner collects no name, e-mail or IP address) and is received through Google Forms (Google LLC), subject to <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google's privacy policy</a>. Legal basis: consent (art. 6.1.a GDPR). Please do not include personal or patient data in the comment; if included, it would be deleted. You may request deletion of a comment by writing to ${OWNER.email}.</p>
<p><b>6. No accounts or cookies.</b> The application requires no registration and sends no e-mails or commercial communications.</p>
<p><b>7. Your rights.</b> You may exercise your rights of access, rectification, erasure, objection, restriction and portability by writing to ${OWNER.email}, and lodge a complaint with the Spanish Data Protection Agency (www.aepd.es). Since no identifiable personal data is collected, in practice there is no data to hand over or delete.</p>
<p><b>8. Changes.</b> This policy may be updated; version date ${TERMS_VERSION}.</p>`,
